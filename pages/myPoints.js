  ...
  return (
    <div>
      <Layout>
        ...
        <div className="  m-10 border-solid border-4 border-primary h-60 p-1">
          <p className="p-5">
          ...
          <Link href="/rewardProgram">
            <a className=" border-solid border-2 border-primary text-sm flex justify-center m-2 bg-gray-100 p-1">
              {" "}
              Voir les conditions
            </a>
          </Link>
          <p className=" border-solid border-2 border-primary text-sm flex justify-center m-2 bg-gray-100 p-1">
            {" "}
            Utiliser mes points
          </p>
        </div>
        <div className="  m-5  border-solid border-4 border-primary h-25  ">
          <p className="p-5">
